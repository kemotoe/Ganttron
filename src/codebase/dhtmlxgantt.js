...
(c) Dinamenta, UAB.
*/
(gantt = { version: "4.1.0" }), (gantt.event = function(t, e, n) {
  t.addEventListener
  ...
  (this._obj = t), e && (this._settings = e), gantt._eventable(
    this
  ), this.initEventAccessor(), (this._drag_start_timer = null), gantt.attachEvent(
    "onGanttScroll",
    gantt.bind(function(t, e) {
      this.clearDragTimer();
    }, this)
    ...
    gantt.bind(function(n) {
      (e.original_target = { target: n.target || n.srcElement }), gantt.config
        .touch
        ? (
            this.clearDragTimer(),
  ...
  traceDragEvents: function(t) {
    var e = gantt.bind(function(e) {
      ...
      n = (
        ...
        gantt.bind(function(t) {
          return t &&
            t.preventDefault &&
            t.preventDefault(), ((t || event).cancelBubble = !0), gantt.defined(this.config.updates_per_second) && !gantt._checkTimeout(this, this.config.updates_per_second) ? !0 : e(t);
        }, this)
      ),
      a = gantt.bind(function(e) {
        return gantt.eventRemove(
          ...
          this._evs.move,
          n
        ), gantt.eventRemove(document.body, this._evs.up, a), this.dragEnd(t);
      }, this);
    gantt.event(document.body, this._evs.move, n), gantt.event(
      document.body,
      this._evs.up,
      a
    );
  ...
  backupEventTarget: function(t) {
    if (gantt.config.touch) {
      var e = this.eventAccessor(t),
        n = e.target || e.srcElement,
        a = n.cloneNode(!0);
      (this.config.original_target = {
        target: a
      }), (this.config.backup_element = n), n.parentNode.appendChild(
        a
  ...
  initEventAccessor: function() {
    ...
    (this.eventAccessor = function(t) {
      ...
      (window.navigator.msPointerEnabled
        ? (
            (t.move = "MSPointerMove"),
            (t.down = "MSPointerDown"),
            (t.up = "MSPointerUp"),
            (this.eventAccessor = function(t) {
  ...
  dragStart: function(t, e) {
    (this.config = {
      ...
      " gantt_noselect"), gantt.config.touch && this.dragMove(t, e);
  },
  dragMove: function(t, e) {
    var n = this.eventAccessor(e);
    if (n) {
      if (!this.config.marker && !this.config.started) {
        var a = this.getPosition(n);
        if (gantt.config.touch || this.checkPositionChange(a)) {
          if (
            (
      ...
      return this.config.ignore
        ? void 0
        : (
            (n.pos = this.getPosition(n)),
            (this.config.marker.style.left = n.pos.x + "px"),
            (this.config.marker.style.top = n.pos.y + "px"),
            this.callEvent("onDragMove", [t, n]),
            !1
          );
    }
  },
    ...
    this.bind(function(e, n) {
      ...
      if (
        ...
        if (
          ...
          if (!this.hasChild(l.id)) return void this.moveTask(r.id, -1, l.id);
          if (this.getGlobalTaskIndex(l.id)) return;
        }
        for (
          var d = this.getGlobalTaskIndex(l.id),
  ...
  initColSizes: function(t, e, n, a) {
    ...
    for (var r = t.ignore_x || {}, o = 0; o < t.trace_x.length; o++)
      r[t.trace_x[o].valueOf()] || t.display_count == t.count
        ? (t.width[o] = 0)
        : (t.width[o] = 1);
    this.adjustSize(
  ...
  _resize: function(t, e, n) {
    ...
    n.left
      ...
      (n.left
        ? (t.start_date = gantt.calculateEndDate(t.end_date, -1))
        ...
        if (s)
          if (
            ...
            (s.start_x = r.x), (s.start_y =
              r.y), (s.obj = a), (this.drag.start_drag = s);
  ...
  _fix_dnd_scale_time: function(t, e) {
    ...
    function a(t) {
      gantt.isWorkTime(new Date(t.end_date - 1)) ||
        (t.end_date = gantt.calculateEndDate(
          t.end_date,
          1,
          gantt.config.duration_unit
  ...
  function t(t, e, n) {
    ...
    return (a.y += gantt._get_task_height() / 2), (n = n || 0), (a.x +=
      (e ? -1 : 1) * n), a;
  }
  function e(t) {
    var e = a(),
  ...
  (this._min_date = a.start_date), (this._max_date = a.end_date), (this
    ...
    this.date[t + "_start"](this._min_date),
    -1,
    t
  ...
  var i = gantt.getState();
  +n.end_date <= +i.max_date &&
    t.appendChild(a(e + " task_right")), +n.start_date >= +i.min_date &&
    t.appendChild(a(e + " task_left"));
  ...
  i =
    e || a
      ...
      : t.end_date || this.calculateEndDate(this._default_task_date(t));
  ...
  default_calendar: function() {
    return { hours: [0, 17], dates: { 0: !1, 6: !1 } };
  },
  ...
  set_time: function(t) {
    var e = void 0 !== t.hours ? t.hours : !0,
      n = this._timestamp(t);
    null !== n
      ? (this.get_calendar().dates[n] = e)
      : (this.get_calendar().hours = e), this._working_units_cache.clear();
  },
  get_calendar: function() {
    return (gantt.config.worktimes && gantt.config.worktimes.global) ||
      this.reset_calendar(), gantt.config.worktimes.global;
  },
  reset_calendar: function() {
    (gantt.config.worktimes = {}), (gantt.config.worktimes.global = this.default_calendar());
  },
  ...
  is_working_unit: function(t, e, n) {
    ...
    return -1 == a &&
      (
        (a = this._check_is_working_unit(t, e, n)),
        this._working_units_cache.put(e, t, a)
      ), a;
  },
  _check_is_working_unit: function(t, e, n) {
    return void 0 === n && (n = this._get_unit_order(e)), void 0 === n
      ? !0
      : n && !this.is_working_unit(t, this.units[n - 1], n - 1)
        ? !1
        : this["is_work_" + e] ? this["is_work_" + e](t) : !0;
  },
  ...
  is_work_hour: function(t) {
    for (
      var e = this.get_working_hours(t), n = t.getHours(), a = 0;
      a < e.length;
      a += 2
    ) {
  ...
  next_date: function(t, e, n) {
    ...
    return s || (s = this.intern_dates_pull[i] = {}), s[a] ||
      (s[a] = gantt.date.add(t, n, e)), s[a];
  },
  get_work_units_between_generic: function(t, e, n, a) {
    for (
      var i = new Date(t), s = new Date(e), a = a || 1, r = 0;
      i.valueOf() < s.valueOf();

    )
      this.is_working_unit(i, n) && r++, (i = this.next_date(i, n, a));
    return r;
  },
  get_hours_per_day: function(t) {
    for (var e = this.get_working_hours(t), n = 0, a = 0; a < e.length; a += 2)
      n += e[a + 1] - e[a] || 0;
    return n;
  },
  get_work_hours_for_range: function(t, e) {
    for (
      ...
      this.is_working_unit(a, "day") &&
        (n += this.get_hours_per_day(a)), (a = this.next_date(a, "day", 1));
    return n;
  },
  get_work_units_between_hours: function(t, e, n, a) {
    var i = new Date(t),
      s = new Date(e),
      a = a || 1,
      r = new Date(i),
    ...
    if (s.valueOf() <= o.valueOf())
      return this.get_work_units_between_generic(t, e, n, a);
    var _ = gantt.date.day_start(new Date(s)),
      l = s,
      d = this.get_work_units_between_generic(r, o, n, a),
      g = this.get_work_units_between_generic(_, l, n, a),
      h = this.get_work_hours_for_range(o, _);
    return (h = Math.floor(h / a + d + g));
  },
  get_work_units_between: function(t, e, n, a) {
    return n
      ? "hour" == n
        ? this.get_work_units_between_hours(t, e, n, a)
        : this.get_work_units_between_generic(t, e, n, a)
      : !1;
  },
  is_work_units_between: function(t, e, n, a) {
    if (!n) return !1;
    for (
      var i = new Date(t), s = new Date(e), a = a || 1;
      i.valueOf() < s.valueOf();
...
}), gantt._working_time_helper.reset_calendar(), (gantt.getTask = function(t) {
  ...
  return gantt.defined(e) || (e = this.getParent(t) || 0), this.isTaskExists(
    e
  ...
  (t.start_date =
    ...
    t.end_date || this.calculateEndDate(t.start_date, t.duration));
  ...
  return this._deleteRelatedTasks(t, e), this._deleteRelatedLinks(
    ...
    (this.callEvent("onAfterTaskDelete", [t, n]), this.refreshData()), !0;
  ...
  return t instanceof Date && (t = { date: t }), (t.dir =
    t.dir || "any"), (t.unit =
    t.unit || this.config.duration_unit), e.get_closest_worktime(t);
}), (gantt.calculateDuration = function(t, e) {
  var n = this._working_time_helper;
  return n.get_work_units_between(
    t,
    e,
    this.config.duration_unit,
    this.config.duration_step
  ...
  var n = this._working_time_helper;
  return n.is_work_units_between(
    t,
    e,
    this.config.duration_unit,
    this.config.duration_step
  ...
  var a = this._working_time_helper,
    i = e >= 0 ? 1 : -1;
  return a.add_worktime(
    t,
    Math.abs(e),
    n || this.config.duration_unit,
    i * this.config.duration_step
  );
  ...
  var e = null;
  return (t.duration || 0 === t.duration) && (e = t.duration), e &&
  ...
  void 0 === t.$rendered_type
    ...
    : t.$rendered_type != e &&
      (
        ...
        delete t.$no_start,
        (t.$rendered_type = e)
      ), (void 0 !== t.$no_end && void 0 !== t.$no_start) ||
    e == this.config.types.milestone ||
    (e == this.config.types.project
      ? ((t.$no_end = t.$no_start = !0), this._set_default_task_timing(t))
      : (
          (t.$no_end = !(t.end_date || t.duration)),
          (t.$no_start = !t.start_date),
          this._isAllowedUnscheduledTask(t) && (t.$no_end = t.$no_start = !1)
        )), e == this.config.types.milestone &&
    (t.end_date = t.start_date), t.start_date &&
    t.end_date &&
    (t.duration = this.calculateDuration(
      t.start_date,
      t.end_date
  ...
  if (t) {
    ...
    if (n.$no_start || n.$no_end) {
      ...
      gantt.resetProjectDates(n), s == n.start_date.valueOf() &&
        r == n.end_date.valueOf() &&
        (i = !1), i && !e && this.refreshTask(n.id, !0);
    }
  ...
  t instanceof Date &&
    (t = { date: t, unit: gantt._tasks.unit, step: gantt._tasks.step });
  var e,
    n,
    a,
    i = t.date,
  ...
  (t.afterUpdate = function() {
    ...
    return a.$no_start &&
      (
        (a.start_date = ""),
        (a.duration = "")
      ), a.$no_end && ((a.end_date = ""), (a.duration = "")), (i[t.action_param] = this.getUserData(e, t.action_param)), i;
  ...
  (gantt.lightbox_events = {}), (gantt.lightbox_events.gantt_save_btn = function(
    ...
    if (e.getAttribute("dhx_button"))
      ...
      -1 != s.indexOf("gantt_custom_button") &&
        (-1 != s.indexOf("gantt_custom_button_")
          ? (
              (n = e.parentNode.getAttribute("index")),
              (i = e.parentNode.parentNode)
            )
          : (
              (n = e.getAttribute("index")),
              (i = e.parentNode),
              (e = e.firstChild)
            ));
  ...
  time: {
    ...
    set_value: function(t, e, n, a) {
      ...
      var d = n[l.start_date] || new Date(),
        g = n[l.end_date] || gantt.calculateEndDate(d, 1);
  ...
  duration: {
    ...
    get_value: function(t, e, n) {
      var a = gantt.form_blocks.duration._get_start_date(t, n),
        ...
        o = { start_date: new Date(a), end_date: new Date(s), duration: i };
  ...
  setTransactionMode: function(t, e) {
    "object" == typeof t
      ? (
          ...
          (this._headers = this._headers || t.headers),
          (this._payload = this._payload || t.payload)
        )
      : ((this._tMode = t), (this._tSend = e)), "REST" == this._tMode &&
      ((this._tSend = !1), (this._endnm = !0));
  },
  escape: function(t) {
  ...
  _sendData: function(t, e) {
    if (t) {
      ...
      if ("GET" == this._tMode)
        gantt.ajax.get(
          i + (-1 != i.indexOf("?") ? "&" : "?") + this.serialize(t, e),
          a
        );
      else if ("POST" == this._tMode)
        gantt.ajax.post(i, this.serialize(t, e), a);
        ...
        if (
          ...
          for (var l in this._payload)
            r =
              r +
              this._urlSeparator(r) +
              this.escape(l) +
              "=" +
              this.escape(this._payload[l]);
        gantt.ajax.query({
          url: r,
          method: _,
  ...
  _getAllData: function(t) {
    for (var e = {}, n = !1, a = 0; a < this.updatedRows.length; a++) {
      ...
      this._in_progress[i] ||
        this.is_invalid(i) ||
        (this.callEvent("onBeforeUpdate", [
          i,
          this.getState(i),
          this._getRowData(i)
        ]) &&
          (
            (e[i] = this._getRowData(i, i + this.post_delim)),
            (n = !0),
  ...
  var i = { delete: gantt.deleteTask, isExist: gantt.isTaskExists };
  "links" == a &&
    (
  ...
  this.callEvent("onBeforeGanttReady", []), e &&
    ...
    (this.config.scroll_size = this._detectScrollSize()), gantt.event(
    window,
    "resize",
    this._on_resize
  ...
  return this.$task && this.$task_data
    ? { x: this.$task.scrollLeft, y: this.$task_data.scrollTop }
    : null;
  ...
  return _ && (l.x = Math.max(this._x - (r ? a : 2), 0)), r &&
    (l.y = Math.max(this._y - (_ ? a : 0) - this.config.scale_height, 0)), l;
  ...
  "force" != this.config.touch &&
    (this.config.touch =
      ...
      (-1 != navigator.userAgent.indexOf("Mobile") ||
        ...
        -1 != navigator.userAgent.indexOf("Touch"))), this.config.touch &&
    (window.navigator.msPointerEnabled
      ? this._touch_events(
  ...
  this._gantt_touch_event_ready ||
    ...
    if (!n(t)) {
      ...
      var a = e(t);
      gantt._tasks_dnd.on_mouse_up(a), g &&
        (
          gantt.refreshTask(gantt.locate(g)),
          g.parentNode && (g.parentNode.removeChild(g), gantt._touch_feedback())
        ), (gantt._touch_scroll_active = o = _ = !1), (g = null);
    }
  });
}), (function() {
  function t(t, e) {
